...
### Added
- Added a bounded Styrene release-agent manifest plus tested preview-mode GitHub release post generation, allowlisted staging, stable preview artifact emission, approval metadata mutation, Discord dry-run projection, committed artifact drift coverage, and mode-specific readiness decisions.
