...
1. Define `SecretRef`, `SecretGrant`, `SecretSeedPlan`, `SealedBootstrapBundle`, and `SecretLease` in `auspex-core`.
2. Implement a file-backed grant broker for development.
